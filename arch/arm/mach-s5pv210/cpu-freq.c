...
static struct cpufreq_frequency_table freq_table[] = {
	...
	{L5, 100*1000},
	{0, CPUFREQ_TABLE_END},
#elif defined(CONFIG_OC_1200MHZ)
	{L0, 1200*1000},
	{L1, 1000*1000},
	{L2, 800*1000},
	{L3, 400*1000},
...
static u32 clkdiv_val[6][11] = {
	 ...
	 */
#if defined(CONFIG_OC_1540MHZ)
	/* L0 : [1540/200/200/100][166/83][133/66][200/200] */
...
#elif defined(CONFIG_OC_1420MHZ)
	/* L0 : [1420/200/200/100][166/83][133/66][200/200] */
		...
		unsigned int bus_speed_changing)
{
	...
	if (index == L0)
#if defined(CONFIG_OC_1540MHZ)
		/* APLL FOUT becomes 1540 Mhz */
		__raw_writel(PLL45XX_APLL_VAL_1540, S5P_APLL_CON);
#elif defined(CONFIG_OC_1420MHZ)
		/* APLL FOUT becomes 1420 Mhz */
		__raw_writel(PLL45XX_APLL_VAL_1420, S5P_APLL_CON);
#elif defined(CONFIG_OC_1200MHZ)	 	
...
#if defined(CONFIG_OC_1540MHZ)
	mpll_freq = clk_get_rate(mpll_clk) / 1540 / 1540; /* in MHz */
#elif defined(CONFIG_OC_1420MHZ)
	mpll_freq = clk_get_rate(mpll_clk) / 1420 / 1420; /* in MHz */
#elif defined(CONFIG_OC_1200MHZ)
...
#if defined(CONFIG_OC_1540MHZ)
	apll_freq_max /= 1540; /* in MHz */
#elif defined(CONFIG_OC_1420MHZ)
	apll_freq_max /= 1420; /* in MHz */
#elif defined(CONFIG_OC_1200MHZ)
